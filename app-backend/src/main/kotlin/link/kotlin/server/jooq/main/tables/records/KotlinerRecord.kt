...
open class KotlinerRecord() : UpdatableRecordImpl<KotlinerRecord>(Kotliner.KOTLINER), Record10<Long?, String?, String?, String?, String?, String?, String?, String?, String?, String?> {
    ...
    override fun field4(): Field<String?> = Kotliner.KOTLINER.EMAIL
    override fun field5(): Field<String?> = Kotliner.KOTLINER.FIRST_NAME
    override fun field6(): Field<String?> = Kotliner.KOTLINER.LAST_NAME
    override fun field7(): Field<String?> = Kotliner.KOTLINER.NICKNAME
    override fun field8(): Field<String?> = Kotliner.KOTLINER.PASSWORD
    override fun field9(): Field<String?> = Kotliner.KOTLINER.SALT
    ...
    override fun component7(): String? = nickname
    override fun component8(): String? = password
    override fun component9(): String? = salt
    ...
    override fun value7(): String? = nickname
    override fun value8(): String? = password
    override fun value9(): String? = salt
     ...
     */
    constructor(id: Long? = null, avatar: String? = null, description: String? = null, email: String? = null, firstName: String? = null, lastName: String? = null, nickname: String? = null, password: String? = null, salt: String? = null, totp: String? = null): this() {
        this.id = id
        this.avatar = avatar
