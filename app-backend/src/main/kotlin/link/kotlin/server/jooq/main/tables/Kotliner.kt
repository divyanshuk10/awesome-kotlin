...
import link.kotlin.server.jooq.main.keys.UNIQUE_KOTLINER
...
open class Kotliner(
    ...
    /**
     * The column <code>public.kotliner.email</code>.
     */
    val EMAIL: TableField<KotlinerRecord, String?> = createField(DSL.name("email"), SQLDataType.VARCHAR(500).nullable(false), this, "")
    ...
    /**
     * The column <code>public.kotliner.salt</code>.
     */
    val SALT: TableField<KotlinerRecord, String?> = createField(DSL.name("salt"), SQLDataType.VARCHAR(500).nullable(false), this, "")
    ...
    override fun getUniqueKeys(): List<UniqueKey<KotlinerRecord>> = listOf(UNIQUE_KOTLINER)
