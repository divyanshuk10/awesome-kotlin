...
open class KotlinerDao(configuration: Configuration?) : DAOImpl<KotlinerRecord, link.kotlin.server.jooq.main.tables.pojos.Kotliner, Long>(Kotliner.KOTLINER, link.kotlin.server.jooq.main.tables.pojos.Kotliner::class.java, configuration) {
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfEmail(lowerInclusive: String?, upperInclusive: String?): List<link.kotlin.server.jooq.main.tables.pojos.Kotliner> = fetchRange(Kotliner.KOTLINER.EMAIL, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>email IN (values)</code>
     */
    fun fetchByEmail(vararg values: String): List<link.kotlin.server.jooq.main.tables.pojos.Kotliner> = fetch(Kotliner.KOTLINER.EMAIL, *values)

    /**
     * Fetch a unique record that has <code>email = value</code>
     */
    fun fetchOneByEmail(value: String): link.kotlin.server.jooq.main.tables.pojos.Kotliner? = fetchOne(Kotliner.KOTLINER.EMAIL, value)
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfSalt(lowerInclusive: String?, upperInclusive: String?): List<link.kotlin.server.jooq.main.tables.pojos.Kotliner> = fetchRange(Kotliner.KOTLINER.SALT, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>salt IN (values)</code>
     */
    fun fetchBySalt(vararg values: String): List<link.kotlin.server.jooq.main.tables.pojos.Kotliner> = fetch(Kotliner.KOTLINER.SALT, *values)
